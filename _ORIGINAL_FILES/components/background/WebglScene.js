...
export default class WebglScene {
  ...
  createTextures() {
    ...
    const gradientGreen = new THREE.Texture(this.createGradient('#c0f4fe', '#fff3df'));
    ...
    const gradientBlue = new THREE.Texture(this.createGradient('#d0e3fd', '#ecfffe'));
  ...
  showHelix() {
    TweenLite.killTweensOf(this.y);
    this.renderFlag = true;

    TweenLite.to(this.y, 2, { anim1: -0.45, ease: 'Power2.easeIn' });
    TweenLite.to(this.y, 1.9, { anim2: -0.45, ease: 'Power2.easeIn' });
    TweenLite.to(this.y, 2.1, { anim3: -0.45, ease: 'Power2.easeIn' });
  }

  hideHelix() {
    TweenLite.killTweensOf(this.y);

    TweenLite.to(this.y, 2, { anim1: 0.65, ease: 'Power2.easeOut' });
    TweenLite.to(this.y, 2, { anim2: 0.65, ease: 'Power2.easeOut' });
    TweenLite.to(this.y, 2, {
      anim3: 0.65,
      ease: 'Power2.easeOut',
      onComplete: () => {
        this.renderFlag = false;
