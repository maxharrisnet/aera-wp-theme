...
import s from './ArticleTemplatePage.scss';

export default class ArticleTemplatePage extends Component {
	static propTypes = {
							...
							<header className={s.articleTemplatePage__header}>
								...
								{lead &&
									lead
										...
										.map((paragraph, i) => (
											<p
												className={s.articleTemplatePage__lead}
												key={i}
											>
												<a
													href={articleUrl}
									...
									author
										...
										.map((paragraph, i) => (
											<p
												...
												key={i}
											>
												<span className={s.articleTemplatePage__lead__name}>{paragraph}</span>
											</p> // eslint-disable-line
										))}
							</header>
