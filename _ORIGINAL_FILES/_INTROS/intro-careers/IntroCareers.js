...
import s from "./IntroCareers.scss";
 
export default class IntroCareers extends Component {
  static propTypes = {
    ...
    return (
      ...
      <div className={s(s.intro, { fullHeight })}>
        <div className={s.intro__container}>
          ...
          <p>
            <a href="javascript:;" id="findCareer" className={s.intro__button}>Find a Career</a>
          </p>
        </div>
      </div>
    );
