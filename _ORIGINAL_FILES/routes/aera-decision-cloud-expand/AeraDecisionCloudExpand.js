...
import s from "./AeraDecisionCloudExpand.scss";
...
export default class AeraDecisionCloudExpand extends Component {
    ...
    return (
      <Page>
        <Helmet
          ...
          link = {[
            { rel : "canonical", href : "https://www.aeratechnology.com/aera-decision-cloud" }
          ]}
        />
        ...
        <Intro title="Aera Decision Cloud™" tagline="The Decision Intelligence Platform" fullheight/>
        <Content />
          {/* <ContentItem 
            title="Delloite"
            image={Delloite}
