...
export default class Content extends Component {
  ...
  $(".toggleBtn").click(function () {
    ...
    if ($(this).text().includes("Show")) {
      $(this).contents().first()[0].textContent = "Hide Details ";
      $(this).find(".icon").html("&uarr;"); // angle-up
    } else {
      $(this).contents().first()[0].textContent = "Show Details ";
      $(this).find(".icon").html("&darr;"); // angle-down
    }
  });
                                ...
                                <div class="scroll-btn" id="scrollBtn">&darr;</div>
                                    <div class="section-videoscroll" id="sec1">
                                        <div class="text-section">
                                            ...
                                            <div className={s.decisioncloud__sectionDescription}>
                                            Aera Decision Cloud combines four essential cores that enable Aera to deliver fast decisions and turn them into actions.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="section-videoscroll" id="sec2">
                                        <div class="text-section" data-index="0">
                                            ...
                                            <p>The <strong>Aera Decision Data Model™</strong> unifies real-time data from your systems and outside sources into a decision-ready model. It records every decision made along with its details and outcomes. Over time, this decision memory enables Aera to learn, provide deeper insights, and make smarter, more optimized recommendations.<br/>
                                            
                                              <NavLink to="/decision-data-model" class="text-section-link">Learn More </NavLink>
                                              <a href="javascript:;" class="toggleBtn">Show Details <span class="icon">&darr;</span></a>
                                              <div class="accordion-content">
                                              <div class="box grey">
                                                  <h3>
                                                  Comprehensive Integration
                                                  </h3>
                                                  <p>Unify data across the enterprise, including transactions, analytics, planning data, unstructured inputs, and IoT signals, as well as external sources, through over 250 prebuilt connectors.</p>
                                              ...
                                              <div class="box grey">
                                                  ...
                                                  <p>​Compose analytical, graph, mathematical, AI/ML, simulations, and decision models to deliver contextual recommendations.</p>
                                                  {/* <a href="javascript:;">Explore <img src={explorearrow}/></a> */}
                                              </div>
                                              <div class="box grey">
                                                  <h3>
                                    ...
                                    <div class="section-videoscroll" id="sec3">
                                        <div class="text-section" data-index="1">
                                            ...
                                            <p>Comprehensive <strong>decision engines</strong> support all types of decisions, from advised to assisted to fully automated. Together, they quickly analyze data, apply logic, run simulations, and generate recommendations and actions.<br/>
                                            <NavLink to="/decision-engines" class="text-section-link">Learn More </NavLink>
                                            <a href="javascript:;" class="toggleBtn">Show Details <span class="icon">&darr;</span></a>
                                              <div class="accordion-content">
                                                <div class="box lightGreen">
                                                  ...
                                                  <p>Compose and model decision processes visually by embedding business rules, scenarios, optimization logic, AI/ML models, and agent teams.</p>
                                              ...
                                              <div class="box lightGreen">
                                                  ...
                                                  <p>Harmonize data across internal and external systems, and orchestrate data workloads to build and maintain the Decision Data Model.</p>
                                              ...
                                              <div class="box lightGreen">
                                                  ...
                                                  <p>Continuously improve decision quality by learning from feedback and context to adapt to changing business conditions in real time.</p>
                                                  {/* <a href="javascript:;">Explore <img src={explorearrow}/></a> */}
                                              </div>
                                              </div>
                                            </p>
                                    ...
                                    <div class="text-section" data-index="2">
                                        ...
                                        Agentic Ambient Orchestration™</h5>
                                            ...
                                            <p><strong>Agentic Ambient Orchestration</strong> lets you blend structured and unstructured data, your expertise, and the reasoning power of AI agents (through LLMs) in your decision processes.  Instead of coding decision rules, you can simply prompt and guide agents to automate decisions.
                                            <br/>
                                            <NavLink to="/agentic-ambient-orchestration" class="text-section-link">Learn More </NavLink>
                                            <a href="javascript:;" class="toggleBtn">Show Details <span class="icon">&darr;</span></a>
                                              <div class="accordion-content">
                                              <div class="box AAO">
                                                <h3>
                                            ...
                                            <div class="box AAO">
                                                ...
                                                <p>Configure and manage secure connections to large language models of your choice and map them to specific agents.</p>
                                                {/* <a href="javascript:;">Explore <img src={explorearrow}/></a> */}
                                            </div>
                                              </div>
                                            </p>
                                    ...
                                    <div class="text-section" data-index="3">
                                        ...
                                        Decision Engagement</h5>
                                            ...
                                            <p><strong>Decision Engagement</strong> enables you to interact with Aera through an intuitive, natural language interface, available via chat, voice, desktop, or mobile. You can explore data, get timely guidance, and act on real-time recommendations.<br/>
                                            <NavLink to="/decision-engagement" class="text-section-link">Learn More </NavLink>
                                            <a href="javascript:;" class="toggleBtn">Show Details <span class="icon">&darr;</span></a>
                                              <div class="accordion-content">
                                                <div class="box DE">
                                                  <h3>
                                              ...
                                              <div class="box DE">
                                                  ...
                                                  <p>Receive prescriptive, explainable, and personalized recommendations ​in real-time. Understand context, impact, trade-offs, and take immediate action.</p>
                                              ...
                                              <div class="box DE">
                                                  ...
                                                  <p>Explore and analyze data (from your DDM) through a visual, drillable interface designed to uncover new insights and embed them in recommendations.</p>
                                              ...
                                              <div class="box DE">
                                                  ...
                                                  <p>Monitor the activity, performance, and impacts of your decisions. Identify and continually fine-tune decision logic to optimize decision-making across your enterprise (your decision intelligence network).</p>
            ...
            <div className={s.decisioncloud__container}>
                ...
                <div className={s.decisioncloud__benefitsBox}>
                    <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h3>Comprehensive</h3>
                        <p>Aera provides everything you need to support any type of decision — from advised, to assisted, to fully automated.</p>
                    </div>
                    <div className={s.decisioncloud__benefitsBox}>
                    <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h3>Composable</h3>
                        <p>Easy to build, adjust, and expand, Aera evolves as your business does.</p>
                    </div>
                    <div className={s.decisioncloud__benefitsBox}>
                        <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="120" height="120" rx="8" fill="#B6C8E3"/>
                        ...
                        <h3>Trusted</h3>
                        <p>Aera is transparent and explainable. You always know where the data comes from, why recommendations are given, and how decisions are made.</p>
                    </div>
                    <div className={s.decisioncloud__benefitsBox}>
                        {/* <img src={ZeroLatency}/> */}
                        <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h3>Scalable</h3>
                        <p>From routine tasks to complex strategies, Aera keeps learning and growing with your business.</p>
                    </div>
                    {/* <div className={s.decisioncloud__benefitsBox}>
                    <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="120" height="120" rx="8" fill="#B6E4DB"/>
