  ...
  render() {
    ...
    return (
      <WaypointEnter onEnter={this.animate}>
        <div ref={c => (this.el = c)} className={s.eventsNewItem}>
          <div className={s.eventsNewItem__header}>
            <div className={s.eventsNewItem__city}>{city}</div>
            <div
          ...
          <h3 className={s.eventsNewItem__title}>
            <a
              href={video || link}
              target="_blank"
              rel="noopener noreferrer"
          ...
          <p className={s.eventsNewItem__description}>{description}</p>
