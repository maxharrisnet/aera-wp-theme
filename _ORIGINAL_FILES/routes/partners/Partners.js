...
import Intro, { Loading } from "components/intro-partners";
...
export default class Partners extends Component {
  ...
  render() {
    ...
    return (
      <Page>
        <Helmet
          title="Partners - Aera Technology"
          meta={[
            {
              name: "description",
              content:
          ...
          link = {[
            { rel : "canonical", href : "https://www.aeratechnology.com/partners" }
          ]}
        />
        ...
        <Intro title="Partners" text="We are partnering with a select group of organizations, from consulting firms to technology platforms and data service providers, to accelerate time to value and value over time. Together, we are delivering and scaling Decision Intelligence across the globe." fullheight/>
        <Content />
          {/* <ContentItem 
            title="Delloite"
            image={Delloite}
        ...
        <Request title="Interested in becoming a partner?" text="Schedule Demo" link="/demo" />
      </Page>
    );
  }
}
