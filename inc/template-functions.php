...
function aera_technology_body_classes($classes)
{
  ...
  // Adds a class for any page template being used.
  $template_slug = get_page_template_slug();
  if (! empty($template_slug)) {
    // Remove .php extension and sanitize for use as CSS class.
    $template_class = str_replace('.php', '', $template_slug);
    $template_class = sanitize_html_class($template_class);
