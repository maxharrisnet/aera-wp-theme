			...
			<div class="testdrive__section1wrapper">
				...
				<div class="testdrive__section1rightimg">
					<div class="testdrive__formwrapper" id="form-wrapper">
						<?php
						// Check if Hubspot form plugin shortcode exists
						if (shortcode_exists('hubspot')) {
							echo do_shortcode('[hubspot]');
						} else {
							// Placeholder form
							?>
							<div id="testdriveForm" class="testdrive__formPlaceholder">
								<p><?php esc_html_e('Hubspot form will be embedded here via WordPress plugin.', 'aera'); ?></p>
								<p><?php esc_html_e('Please install and configure the Hubspot WordPress plugin to display the form.', 'aera'); ?></p>
							</div>
							<?php
						}
						?>
...
document.addEventListener('DOMContentLoaded', function() {
	...
	const formPlaceholder = document.querySelector('#testdriveForm');
	if (formPlaceholder) {
