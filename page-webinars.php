...
$hero = wp_parse_args(
  $hero,
  array(
    'title'       => __('Webinars', 'aera'),
    'description' => __('Explore our upcoming and on-demand webinars featuring industry insights and decision intelligence solutions.', 'aera'),
  )
);
...
<main id="primary" class="site-main site-main--webinars">
	<section class="webinars-hero">
		<div class="webinars-hero__container">
			<h1 class="webinars-hero__title"><?php echo esc_html($hero['title']); ?></h1>
	...
	<section class="webinars-on-demand">
		<div class="webinars-on-demand__container">
			<h2 class="webinars-on-demand__title"><?php esc_html_e('On-Demand Webinars', 'aera'); ?></h2>
