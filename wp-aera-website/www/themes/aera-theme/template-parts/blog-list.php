...
$count_text = $count == '1' ? esc_html__( 'result found', 'aera' ) : esc_html__( 'results found', 'aera' );

$aera_blog_title_text        = is_search() ? esc_html__( 'Showing results for ', 'aera' ) . '"' . esc_html( $term ) . '"' : esc_html__( 'Blog', 'aera' ); ?>

<div class="aera-blog--wrapper">
                                ...
                                <div class="aera-blog--post__info-wrap">
                                        ...
                                        <div class="aera-blog--post__title-wrap">
                                            <h3>
                                                <a href="<?php the_permalink(); ?>"
                                                   class="aera-blog--post__title"><?php the_title(); ?></a>
                                            </h3>
                                        </div>
									<?php } ?>
                                    ...
                                    <div class="aera-blog--post__footer">
                                        <div class="aera-blog--post__link">
                                            <a href="<?php the_permalink(); ?>"
                                               class="aheto-link aheto-btn--dark aheto-btn--no-underline"><?php esc_html_e( 'Continue Reading', 'aera' ); ?></a>
                                        </div>
                                        <div class="aera-blog--post__comments">
                                            <b>
